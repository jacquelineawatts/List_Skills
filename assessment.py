...
def print_indices(items):
    ...
    #------------------------- ALTERNATIVE SOLUTION -------------------------
    # USES LIST COMPREHENSION IN PLACE OF FOR LOOP FOR EVERYTHING BUT PRINT.
    # Is there a way to print results from a list comprehension w/out another loop?

    for item in [str(i) + " " + items[i] for i in range(len(items))]:
        print item
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    return list(foods1 & foods2)


    #------------------------- ALTERNATIVE SOLUTION -------------------------
    # USING LISTS ONLY INSTEAD OF SETS
...
def largest_n_items(items, n):
    ...
    # Not as good(?) bc sorted is not in place, requires new list & extra memory
